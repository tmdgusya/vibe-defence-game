...
console.log('Sunflower basic stats:', towerSystem.getTowerStats(TowerType.SUNFLOWER, TowerLevel.BASIC));
console.log('Sunflower basic cost:', towerSystem.getTowerCost(TowerType.SUNFLOWER, TowerLevel.BASIC));
